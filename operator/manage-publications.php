                        ...
                        <div class="panel panel-success hidden" id="hiddenUpdateForm">
                            ...
                            <div class="panel-body">
                                <form role="form" id="UpdatePublication" name="UpdatePublication" action="../REST/manage-publications.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="image">Publication Image <span class="text-danger"><em>(Recommended Size: width=400px, height=400px)</em></span>:</label> <span><strong id="oldImageComment"></strong></span>
                                        <div class="controls">
