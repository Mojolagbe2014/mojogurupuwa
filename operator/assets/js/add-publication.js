$(document).ready(function(){
    ...
    $("form#CreatePublication").submit(function(e){ 
        e.stopPropagation();
        e.preventDefault();
        ...
        $.ajax({
            ...
            error : function(xhr, status) {
                ...
                $("#messageBox, .messageBox").html('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Publication addition failed. '+erroMsg+'</div>');
