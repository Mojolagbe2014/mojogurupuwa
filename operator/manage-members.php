...
<head>
    ...
    <title>Manage Group Members - Prof. Vladimir Okhmatovski's Research Group</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="memberslist" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" class="select-checkbox" id="multi-action-box" /></th>
                                                <th>ID</th>
                                                <th>Actions &nbsp; 
                                                    <button  class="btn btn-success btn-sm multi-activate-member multi-select" title="Change selected member status"><i class="btn-icon-only icon-check"> </i></button> 
                                                    <button class="btn btn-danger btn-sm multi-delete-member multi-select" title="Delete Selected"><i class="btn-icon-only icon-trash"> </i></button>
                                                    <button class="btn btn-primary btn-sm multi-graduated multi-select" title="Change Graduation Status"><i class="btn-icon-only icon-eye-open"> </i></button>
                                                </th>
                                                <th>Picture</th>
                                                <th>Member Name</th>
                                                <th>Program</th>
                        ...
                        <div class="panel panel-success hidden" id="hiddenUpdateForm">
                            ...
                            <div class="panel-body">
                                <form role="form" id="UpdateMember" name="UpdateMember" action="../REST/manage-members.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input data-title="Program" type="text" placeholder="Program" id="program" name="program" data-original-title="Program" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input data-title="member's email" type="email" placeholder="member's email" id="email" name="email" data-original-title="Member's email" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="hidden" name="updateThisMember" id="updateThisMember" value="updateThisMember"/>
                                            <button type="submit" name="submitUpdateMember" id="submitUpdateMember" class="btn btn-danger">Update Details</button> &nbsp; &nbsp;
